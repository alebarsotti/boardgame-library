window.__BGG_LIBRARY_DATA__ = {
  "summary": {
    "generatedAt": "2026-06-13T12:26:13",
    "count": 153,
    "ownCount": 122,
    "prevOwnedCount": 31,
    "recommendations": {
  ...
  "games": [
    ...
    },
    {
      ...
      "searchText": "potion explosion potion explosion horrible guild spanish edition horrible guild spanish potion explosion is a fast-paced puzzle game where players collect ingredient marbles by causing color matches. brew potions to gain magical powers and aim for the most valuable combinations to win. juego de fantasía y rompecabezas donde los jugadores recolectan losetas de ingredientes al hacer coincidir colores. preparan pociones para obtener poderes mágicos y buscan las combinaciones más valiosas para ganar. potion explosion is a game for 2 to 4 players by horrible games. it was designed by lorenzo silva, andrea crespi and stefano castelli. dear students, it's time for the final exams of the potions class! the rules are always the same: take an ingredient marble from the dispenser and watch the others fall. if you connect marbles of the same color, they explode and you can take them, too! complete your potions using the marbles you collect, and drink them to unleash their magical power. remember, though, that to win the student of the year award, being quick won't be enough: you'll also need to brew the most valuable potions in potion explosion! fantasy puzzle contracts open drafting pattern recognition physical removal set collection take that variable set-up owned great-at-2 light teaching-friendly 2 3 4 3"
    },
    {
      "id": 203542,
      "collId": 146439388,
