window.__BGG_LIBRARY_DATA__ = {
  ...
  "games": [
    ...
    },
    {
      ...
      "searchText": "exit: the game – the catacombs of horror exit: the game – the catacombs of horror spanish gloomy vaults lie under the city of lights. the catacombs of paris swallow the light, secrets, and — apparently — also people. after the mysterious disappearance of a friend in the catacombs, players in exit: the game – the catacombs of horror embark on a mysterious search through the underground labyrinth. will players be able to find their friend in time and escape this cavernous world full of dark mysteries? gloomy vaults lie under the city of lights. the catacombs of paris swallow the light, secrets, and — apparently — also people. after the mysterious disappearance of a friend in the catacombs, players in exit: the game – the catacombs of horror embark on a mysterious search through the underground labyrinth. will players be able to find their friend in time and escape this cavernous world full of dark mysteries? like other titles in the series, exit: the game – the catacombs of horror includes components meant to be folded, written upon, or torn, so it's marketed as a single-use game. what's different in this game is that it consists of two parts, with each part being its own challenge. deduction horror puzzle cooperative game owned solo great-at-2 long 1 2 3 4 2"
    },
    {
      "id": 295945,
      "collId": 117484872,
    ...
    },
    {
      ...
      "searchText": "exit: the game – the sinister mansion exit: the game – the sinister mansion spanish exit: the game – the sinister mansion is a puzzle game modeled after escape rooms. starting with season 3, the exit series is divided into difficulty levels. the sinister mansion is categorized at intermediate level. exit: the game – the sinister mansion is a puzzle game modeled after escape rooms. starting with season 3, the exit series is divided into difficulty levels. the sinister mansion is categorized at intermediate level. deduction cooperative game owned solo great-at-2 1 2 3 2"
    },
    {
      "id": 226518,
      "collId": 117484878,
      ...
      "searchText": "exit: the game – the sunken treasure exit: the game – the sunken treasure spanish exit: the game – the sunken treasure is a puzzle game modeled after escape rooms. starting with season 3, the exit series is divided into difficulty levels. \"the sunken treasure\" is categorized at beginners level. exit: the game – the sunken treasure is a puzzle game modeled after escape rooms. starting with season 3, the exit series is divided into difficulty levels. \"the sunken treasure\" is categorized at beginners level. deduction puzzle real-time cooperative game deduction move through deck real-time simulation owned solo great-at-2 light 1 2 3 2"
    },
    {
      "id": 283934,
      "collId": 117484876,
    ...
    },
    {
      ...
      "searchText": "perplexus perplexus spanish perplexus is a 3-d maze game where players must maneuver a small marble around challenging barriers inside a transparent sphere. unlike traditional flat-surface mazes that are composed of one path, perplexus houses various exhilarating tracks with 100 barriers and provides a three dimensional experience. players select which track they would like to attempt, and then must work with gravity and carefully shift, flip, and twist the sphere to guide the marble. perplexus is a 3-d maze game where players must maneuver a small marble around challenging barriers inside a transparent sphere. unlike traditional flat-surface mazes that are composed of one path, perplexus houses various exhilarating tracks with 100 barriers and provides a three dimensional experience. players select which track they would like to attempt, and then must work with gravity and carefully shift, flip, and twist the sphere to guide the marble. action / dexterity maze owned solo quick light teaching-friendly 1 1"
    },
    {
      "id": 180974,
      "collId": 135745058,
      ...
      "searchText": "potion explosion potion explosion spanish potion explosion is a game for 2 to 4 players by horrible games. it was designed by lorenzo silva, andrea crespi and stefano castelli. potion explosion is a game for 2 to 4 players by horrible games. it was designed by lorenzo silva, andrea crespi and stefano castelli. dear students, it's time for the final exams of the potions class! the rules are always the same: take an ingredient marble from the dispenser and watch the others fall. if you connect marbles of the same color, they explode and you can take them, too! complete your potions using the marbles you collect, and drink them to unleash their magical power. remember, though, that to win the student of the year award, being quick won't be enough: you'll also need to brew the most valuable potions in potion explosion! fantasy puzzle contracts open drafting pattern recognition physical removal set collection take that variable set-up owned great-at-2 light teaching-friendly 2 3 4 3"
    },
    {
      "id": 244521,
      "collId": 135744912,
    ...
    },
    {
      ...
      "searchText": "unlock!: short adventures – in pursuit of cabrakan unlock!: short adventures – in pursuit of cabrakan spanish in pursuit of cabrakan is a 24-card (4 cards are advertisements or information cards not used in-game) mini adventure for unlock!, the card-driven escape room game from space cowboys. at the beginning of the adventure, you are at the mouth of a cave in search of a gold statue. in pursuit of cabrakan is a 24-card (4 cards are advertisements or information cards not used in-game) mini adventure for unlock!, the card-driven escape room game from space cowboys. at the beginning of the adventure, you are at the mouth of a cave in search of a gold statue. in pursuit of cabrakan was produced as a special scenario for gen con 2018 events. it also requires a free companion app to play. card game puzzle real-time cooperative game elapsed real time ending real-time storytelling previously-owned solo great-at-2 group quick light teaching-friendly 1 2 3 2"
    },
    {
      "id": 391995,
      "collId": 135745127,
