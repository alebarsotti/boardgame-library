window.__BGG_LIBRARY_DATA__ = {
  "summary": {
    "generatedAt": "2026-05-30T16:33:30",
    "count": 134,
    "ownCount": 118,
    "prevOwnedCount": 15,
    "recommendations": {
  ...
  "games": [
    ...
    },
    {
      ...
      "searchText": "deckscape: test time deckscape: test time spanish deckscape: test time is a cooperative card game where players work together to solve puzzles and escape a locked laboratory. as doctor thyme's students, you must use your skills to unlock the exit before time runs out. juego de cartas cooperativo donde los jugadores resuelven acertijos para escapar de un laboratorio cerrado. como estudiantes del doctor thyme, deben usar sus habilidades para abrir la salida antes de que se acabe el tiempo. deckscape: test time is the first title in a series of cooperative games inspired by real escape rooms in which a group of people are \"trapped\" inside a room full of puzzles and odd items. the goal of the game is to solve puzzles, understand the plot of the story, and make intelligent use of the items provided in order to exit from the room as quickly as possible. in deckscape: test time, you have been selected from doctor thyme's most brilliant students for a special project. he'll test your skills, and if you succeed, you'll get a unique chance to help him on his newest and greatest invention. while he's explaining his project, he distractedly pushes a button: an alarm cries loudly and heavy gratings shut all the windows and the exit door. the laboratory is locked! doc thyme falls through a trapdoor below his feet and the lights turn off. will you be able to pass doctor thyme's exam and exit his laboratory? using just sixty cards, you will take part in a hectic adventure, without leaving home. —description from the publisher card game puzzle real-time cooperative game move through deck real-time owned solo great-at-2 group light 1 2 3 4 2"
    },
    {
      "id": 230498,
      "collId": 135745292,
    ...
    },
    {
      ...
      "searchText": "happy salmon happy salmon spanish a fast-paced, silly card game where players call out actions on their cards. match with another player to celebrate with the action and discard your card. first to empty their hand wins. juego de cartas rápido y divertido donde los jugadores gritan las acciones de sus cartas. al coincidir con otro jugador, celebran realizando la acción y descartan una carta. gana quien se queda sin cartas primero. happy salmon is a simple, ultra-fast, very silly card game. there are no turns. players call out the action shown on their cards as fast as they can. when two players have a match, they celebrate by performing the action. actions include the classic \"high 5\", the unifying \"pound it\", the frantic \"switcheroo\", and the delightful and bizarre \"happy salmon\". each time a player celebrates a match, they quickly discard a card. the first person to get rid of all their cards wins. animals children's game party game real-time real-time owned group quick light teaching-friendly 4 5 6 7 8 5 6"
    },
    {
      "id": 2655,
      "collId": 135745426,
    ...
    },
    {
      ...
      "searchText": "risk risk hasbro english edition hasbro spanish a classic strategy game of global conquest. players build armies, attack opponents, and aim to control all territories. reinforcements are gained through territory control and bonus cards. juego de estrategia donde los jugadores conquistan territorios controlando ejércitos y atacando a los rivales. las bonificaciones se obtienen mediante el control de territorios y cartas especiales. possibly the most popular, mass market war game. the goal is conquest of the world. each player's turn consists of: - gaining reinforcements through number of territories held, control of every territory on each continent, and turning sets of bonus cards. - attacking other players using a simple combat rule of comparing the highest dice rolled for each side. players may attack as often as desired. if one enemy territory is successfully taken, the player is awarded with a bonus card. - moving a group of armies to another adjacent territory. territory building wargame area majority / influence area movement dice rolling hand management income player elimination point to point movement set collection variable set-up owned group 3 4 5 6 4"
    },
    {
      "id": 199561,
      "collId": 135745065,
